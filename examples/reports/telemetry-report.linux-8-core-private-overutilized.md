...
| Metric | Value |
|:-------|------:|
| **Runner Type** | `Linux 8-core Larger Runner` |
| **This Run** | $0.11 (5 min) |
| **Est. Monthly** (10 runs/day) | $33.00 |
...
**Recommended Runner: Linux 16-core Larger Runner (16-core, 64GB RAM)**

**Why:** Both CPU (93%) and memory (92%) are near limits.

**Expected Performance:** ~2.0x faster (upgrade from 8 to 16 cores)


**Cost Impact (accounting for faster execution):**
- Current: $0.11/run (5 min @ $0.022/min)
- Recommended: $0.11/run (est. 2.5 min @ $0.044/min)
...
- Fewer timeouts: 30→3 per month = **$172/month savings** (Assuming 10% timeout rate at current utilization, ~5 min dev time per timeout)

**Total Hidden Value: ~$1109/month** in productivity and reliability improvements!
