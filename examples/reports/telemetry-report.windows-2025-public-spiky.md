...
> **🔴 Status: Needs Attention** • Duration: 1.5m • Samples: 20
...
xychart-beta
    ...
    x-axis "Time (seconds)" ["0", "4", "9", "13", "18", "22", "27", "31", "36", "40", "45", "49", "54", "58", "63", "67", "72", "76", "81", "85"]
    y-axis "Usage %" 0 --> 100
...
|:-------|------:|---------:|
| 📥 **Disk Read** | 90.0 MB | 1.0 MB/s |
| 📤 **Disk Write** | 63.0 MB | 716.8 KB/s |
| 🌐 **Network RX** | 72.0 MB | 819.2 KB/s |
| 🌐 **Network TX** | 45.0 MB | 512.0 KB/s |
...
|:-----|:--------:|:-------:|:-------:|:-------:|:-------:|
| Install Dependencies | 25.0s | 25.0% | 25.0% | 43.3% | 50.0% |
| Build Application | 25.0s | 25.0% | 25.0% | 41.7% | 50.0% |
| 🔥 Run Tests | 40.0s | 51.2% | 95.0% | 41.2% | 50.0% |


> 💡 **Insights:** Longest step: **Run Tests** (40.0s) • 
> Heaviest CPU: **Run Tests** (51.2%)
...
This job ran on `Windows 2025 Standard Runner` at **no cost** (standard GitHub-hosted runner on public repository).
...
**Recommended Runner: Windows 4-core Larger Runner (4-core, 16GB RAM)**
...
- **Recommended: $0.022/run** (est. 1.0 min @ $0.022/min)
- **Additional cost per run: +$0.022**

**Monthly Cost Comparison** (if you run 10 times/day, 300 runs/month):
- **Current: FREE** ($0/month on free tier)
- **Recommended: $6.60/month** ($0.022/run × 300 runs)
...
**Reliability improvements:** Fewer timeouts saves ~$339/month (Assuming 20% timeout rate at current utilization, ~5 min dev time per timeout)

**Total hidden value: ~$714/month** in productivity and reliability.
