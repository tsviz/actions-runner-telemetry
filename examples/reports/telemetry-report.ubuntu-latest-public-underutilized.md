...
> **🟢 Status: Healthy** • Duration: 20.0s • Samples: 20
...
|:-------|------:|---------:|
| 📥 **Disk Read** | 20.0 MB | 1.0 MB/s |
| 📤 **Disk Write** | 14.0 MB | 716.8 KB/s |
| 🌐 **Network RX** | 16.0 MB | 819.2 KB/s |
| 🌐 **Network TX** | 10.0 MB | 512.0 KB/s |
...
|:-----|:--------:|:-------:|:-------:|:-------:|:-------:|
| 🔥 Install Dependencies | 5.0s | 2.3% | 4.0% | 8.0% | 10.0% |
| Build Application | 5.0s | 2.3% | 4.0% | 7.5% | 10.0% |
| Run Tests | 8.0s | 2.3% | 4.0% | 7.7% | 10.0% |


> 💡 **Insights:** Longest step: **Run Tests** (8.0s) • 
...
**20s (100%)** of job time had minimal CPU activity.


> ℹ️ **Note:** This job is short (20.0s). Utilization and idle metrics can be skewed on brief runs.
